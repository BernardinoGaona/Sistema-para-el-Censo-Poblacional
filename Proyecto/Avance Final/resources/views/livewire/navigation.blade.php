  ...
  <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    ...
    @auth
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <!-- Boton Notificacion -->
            <button type="button" class="p-1 rounded-full text-yellow-500 hover:text-white focus:outline-none {{-- focus:ring-2 focus:ring-offset-2 --}}  focus:ring-white">
            <span class="sr-only"></span>
    ...
    @else
        ...
        <div>
            <a href="{{route('login')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-3xl font-medium">
                Login
            </a>
            <a href="{{route('register')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-3xl font-medium">
                Register
            </a> 
        </div>
